                    ...
                    <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar" data-set="bs-sidebar">
                        <div class="js-append-around">
                            <ul class="nav nav-pills flex-column">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">Overview <span
                                            class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="confing/addproject.php">Add product</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                    <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                        <div class="row">
                            ...
                            <div class="col-sm-5 mx-auto">
                                <div class="row">
                                    <a href="confing/logout-config.php" class="mr-4	text-dark">
                                        <div class="btn btn-outline-success">Log out</div>
                                    </a>
                       ...
                       $result = $conn->query($sql);
                        ...
                        <div class='row'>
                            ...
                            <div class="col-sm-12 col-lg-4 mb-4  ">
                                ...
                                <!-- script delet in the top of the page -->
                                <div class="btn btn-outline-danger">
                                    <a href="dashbord.php?id=<?=$row['id']; ?>">delete</a>
                                </div>
                                <!-- btn to update data from data base  -->
                                <div class="btn btn-outline-success">
                                    <a href="confing/update.php?id=<?=$row['id']; ?>">update</a>
                                </div>
                            </div>
